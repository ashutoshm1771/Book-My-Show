...
namespace Book_My_Show.Services
{
    public class MovieServices : IMovieServices
    {
        ...
        {
            var sqlQuery = "INSERT INTO Movies (Name,ImbdRating,Category,Genre,ReleaseDate,ActorName,ActressName,CoverPhoto,ThemePhoto) VALUES (@Name,@ImbdRating,@Category,@Genre,@ReleaseDate,@ActorName,@ActressName,@CoverPhoto,@ThemePhoto)";
